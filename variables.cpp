...
const std::string reports_webhook = //gitignore github
...
const std::string blacklisted_users[3] = //ignore this for github
...
const std::string description_slashcmd_infoservidor = "Muestra toda la información a mi disposición sobre el servidor en el que se ejecuta
